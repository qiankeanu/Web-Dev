...
export class ProductsComponent {
  ...
  sharing(id: number): void {
    console.log("Sharing function called with id:", id);
    ...
    console.log("Telegram URL:", telegramShareUrl);
