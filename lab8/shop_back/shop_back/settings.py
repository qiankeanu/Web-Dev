...
SECRET_KEY = 'django-insecure-hi7wpyn6501%&wqt#5ztu_(d3lrl8cq&mtpgpc93+0cpzkubpx'
...
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': (
        'rest_framework.renderers.JSONRenderer',  # Отключает HTML, оставляет только JSON
    )
}
